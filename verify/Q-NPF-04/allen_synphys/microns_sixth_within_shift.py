...
def main():
    specs = [('6_4','microns_sixth_trial_level_contract.json','microns_sixth_trial_level_result.json','microns_sixth_scan_contrast_pairs.json')]
    inputs = []
    ...
    save('microns_sixth_within_shift_contract.json',dict(
        ...
        selection='Sixth scan6/4; both timings; all10/first5/last5; all53 registered targets. All6 scenarios; no favorable selection.',
    ...
    save('microns_sixth_within_shift_result.json',dict(results=out,status='DESCRIPTIVE_WITHIN_TRIAL_ALIGNMENT_CONTROL',limits='Not calibrated p-values or independent animal replication.'))
    for r in out:
