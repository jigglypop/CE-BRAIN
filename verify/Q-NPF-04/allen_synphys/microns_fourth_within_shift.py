...
def main():
    specs = [('5_7','microns_fourth_trial_level_contract.json','microns_fourth_trial_level_result.json','microns_fourth_scan_contrast_pairs.json')]
    inputs = []
    ...
    save('microns_fourth_within_shift_contract.json',dict(
        ...
        selection='Fourth scan5/7; both timings; all10/first5/last5; all35 registered targets. All6 scenarios; no favorable selection.',
    ...
    save('microns_fourth_within_shift_result.json',dict(results=out,status='DESCRIPTIVE_WITHIN_TRIAL_ALIGNMENT_CONTROL',limits='Not calibrated p-values or independent animal replication.'))
    for r in out:
