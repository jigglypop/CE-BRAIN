...
save('peng2024_er_distance_contract.json', {
    ...
    'gates': '3D coordinate norm and reverse distance agree; prior coefficient reproduced; direct augmented least squares agrees',
...
for record in prior['records']:
    ...
    for r in selected:
        ...
        coords = [float(ca['coordinate_'+str(k)])-float(cb['coordinate_'+str(k)]) for k in (1,2,3)]
...
out={'contract_sha256':sha(HERE/'peng2024_er_distance_contract.json'),
...
save('peng2024_er_distance_result.json',out)
