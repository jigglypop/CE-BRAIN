...
def main():
    ...
    save('randi_raw_prediction_session9_contract.json', contract)
    ...
    result = {'contract_sha256': sha(HERE / 'randi_raw_prediction_session9_contract.json'),
    ...
    save('randi_raw_prediction_session9_result.json', result)
