...
save('planert2025_masked_presence_contract.json',{
...
out={'contract_sha256':sha(HERE/'planert2025_masked_presence_contract.json'),'dyads':len(pairs),'directions':len(y),'positive_directions':int(y.sum()),
...
save('planert2025_masked_presence_result.json',out)
