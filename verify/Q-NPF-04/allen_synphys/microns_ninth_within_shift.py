...
def main():
    specs = [('7_3','microns_ninth_trial_level_contract.json','microns_ninth_trial_level_result.json','microns_ninth_scan_contrast_pairs.json')]
    inputs = []
    ...
    save('microns_ninth_within_shift_contract.json',dict(
        ...
        selection='Ninth scan7/3; both timings; all10/first5/last5; all36 registered targets. All6 scenarios; no favorable selection.',
    ...
    save('microns_ninth_within_shift_result.json',dict(results=out,status='DESCRIPTIVE_WITHIN_TRIAL_ALIGNMENT_CONTROL',limits='Not calibrated p-values or independent animal replication.'))
    for r in out:
