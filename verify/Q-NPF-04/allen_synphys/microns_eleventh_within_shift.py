...
def main():
    specs = [('8_5','microns_eleventh_trial_level_contract.json','microns_eleventh_trial_level_result.json','microns_eleventh_scan_contrast_pairs.json')]
    inputs = []
    ...
    save('microns_eleventh_within_shift_contract.json',dict(
        ...
        selection='Eleventh analyzed scan8/5; both timings; all10/first5/last5; all44 registered targets. All6 scenarios; no favorable selection.',
    ...
    save('microns_eleventh_within_shift_result.json',dict(results=out,status='DESCRIPTIVE_WITHIN_TRIAL_ALIGNMENT_CONTROL',limits='Not calibrated p-values or independent animal replication.'))
    for r in out:
