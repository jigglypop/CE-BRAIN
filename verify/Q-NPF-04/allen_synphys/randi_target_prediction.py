...
def main():
    ...
    save('randi_target_prediction_contract.json', contract)
    ...
    result = {'contract_sha256': sha(HERE / 'randi_target_prediction_contract.json'),
    ...
    save('randi_target_prediction_result.json', result)
