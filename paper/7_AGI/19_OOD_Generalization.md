...
`paper/8_리만/mra_paper.md` § 7.7 의 raw 결과를 AGI 관점에서 재해석한다.
...
- 분석 표 + verdict: `paper/8_리만/mra_paper.md` § 7.7
...
- (Internal) `paper/7_AGI/1_AGI.md`, `2_Architecture.md`, `8_Roadmap.md`.
- (Internal) `paper/8_리만/mra_paper.md` — full ablation data.
