"""Transfer verified polygon quadrature ranks to positive radial contours."""
...
if __package__:
    ...
    from .verified_rational_radial_contour_residual import (
    ...
    from verified_rational_radial_contour_residual import (  # type: ignore[no-redef]
        ExactRadialResidualWitnessConstruction,
        VerifiedResidualRationalRadialContour,
        exact_radial_nominal_inverse_witnesses,
        verified_componentwise_residual_rational_radial_contour,
...
class VerifiedRadialPolygonRankBridge:
    status: str
    validation_level: str | None
    radial_construction: ExactRadialResidualWitnessConstruction
    radial_certificate: VerifiedResidualRationalRadialContour | None
    ...
    radial_family_rank_verified: bool
    radial_projector_quadrature: tuple[tuple[QComplex, ...], ...] | None
    radial_projector_operator_error_upper: Fraction | None
...
def verified_radial_rank_via_inscribed_polygon(
    ...
    *,
    ...
    machin_terms: int = 8,
) -> VerifiedRadialPolygonRankBridge:
    """Certify a positive radial contour rank through its inscribed polygon."""
    ...
    construction = exact_radial_nominal_inverse_witnesses(
        nominal_transition,
        center=raw_center,
        axis_u=raw_axis_u,
        axis_v=raw_axis_v,
    ...
    common = dict(
        radial_construction=construction,
    ...
    if construction.approximate_inverses is None:
        return VerifiedRadialPolygonRankBridge(
            status=construction.status,
            validation_level=None,
            radial_certificate=None,
            ...
            radial_family_rank_verified=False,
            radial_projector_quadrature=None,
            radial_projector_operator_error_upper=None,
            smooth_contour_quadrature_rank_verified=False,
            **common,
        )
    radial_certificate = verified_componentwise_residual_rational_radial_contour(
        nominal_transition,
    ...
    if radial_certificate.validation_level is None:
        return VerifiedRadialPolygonRankBridge(
            status=radial_certificate.status,
            validation_level=None,
            radial_certificate=radial_certificate,
            adaptive_polygon=None,
            normalized_sector_homotopy_margin_lower=(
                radial_certificate.normalized_robust_delta_lower
            ),
            sector_homotopy_resolvent_verified=False,
            certified_nominal_rank=None,
            radial_family_rank_verified=False,
    ...
    return VerifiedRadialPolygonRankBridge(
        status=(
            "VERIFIED_RATIONAL_RADIAL_POLYGON_HOMOTOPY_RIESZ_RANK"
            if rank_verified
            else "RATIONAL_RADIAL_POLYGON_HOMOTOPY_RANK_UNRESOLVED"
        ),
        validation_level=(
            "VERIFIED_RATIONAL_RADIAL_POLYGON_HOMOTOPY_RIESZ_RANK"
            if rank_verified
        ...
        radial_family_rank_verified=rank_verified,
        radial_projector_quadrature=(
            final.scaled_projector_quadrature if rank_verified else None
        ),
        radial_projector_operator_error_upper=(
...
__all__ = [
    "VerifiedRadialPolygonRankBridge",
    "verified_radial_rank_via_inscribed_polygon",
]
