"""Transfer polygon ranks to periodic piecewise-polynomial radial contours."""
...
class VerifiedPiecewisePolynomialRadialPolygonRankBridge:
    status: str
    validation_level: str | None
    spline_construction: ExactPiecewisePolynomialRadialResidualWitnessConstruction
    spline_certificate: VerifiedResidualPiecewisePolynomialRadialContour | None
    ...
    spline_family_rank_verified: bool
    spline_projector_quadrature: tuple[tuple[QComplex, ...], ...] | None
    spline_projector_operator_error_upper: Fraction | None
...
def verified_piecewise_polynomial_radial_rank_via_inscribed_polygon(
    ...
    *,
    ...
    machin_terms: int = 8,
) -> VerifiedPiecewisePolynomialRadialPolygonRankBridge:
    """Certify a periodic polynomial radial C^q contour via its knot polygon."""
    ...
    construction = exact_piecewise_polynomial_radial_nominal_inverse_witnesses(
        nominal_transition,
        center=raw_center,
        axis_u=raw_axis_u,
        axis_v=raw_axis_v,
    ...
    common = dict(
        spline_construction=construction,
    ...
    if construction.approximate_inverses is None:
        return VerifiedPiecewisePolynomialRadialPolygonRankBridge(
            status=construction.status,
            validation_level=None,
            spline_certificate=None,
            ...
            spline_family_rank_verified=False,
            spline_projector_quadrature=None,
            spline_projector_operator_error_upper=None,
            smooth_contour_quadrature_rank_verified=False,
            **common,
        )
    certificate = verified_componentwise_residual_piecewise_polynomial_radial_contour(
        nominal_transition,
    ...
    if certificate.validation_level is None:
        return VerifiedPiecewisePolynomialRadialPolygonRankBridge(
            ...
            validation_level=None,
            spline_certificate=certificate,
            adaptive_polygon=None,
    ...
    return VerifiedPiecewisePolynomialRadialPolygonRankBridge(
        status=(
            "VERIFIED_PIECEWISE_POLYNOMIAL_RADIAL_POLYGON_RIESZ_RANK"
            if rank_verified
            else "PIECEWISE_POLYNOMIAL_RADIAL_POLYGON_RANK_UNRESOLVED"
        ),
        validation_level=(
            "VERIFIED_PIECEWISE_POLYNOMIAL_RADIAL_POLYGON_RIESZ_RANK"
            if rank_verified
        ...
        spline_family_rank_verified=rank_verified,
        spline_projector_quadrature=(
            final.scaled_projector_quadrature if rank_verified else None
        ),
        spline_projector_operator_error_upper=(
...
__all__ = [
    "VerifiedPiecewisePolynomialRadialPolygonRankBridge",
    "verified_piecewise_polynomial_radial_rank_via_inscribed_polygon",
]
