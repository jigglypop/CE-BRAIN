...
대상: $ARGUMENTS (Q-id, 또는 "새 질문: <제목>" — 새 질문이면 먼저 `ledger.py add-question --id Q-xxxx --title "..." --kind conjecture --priority 1 --origin "paper/진전_원장.md §2"`로 등록하고 `next-question`·`bump-attempt`로 attempt 1을 연다)
